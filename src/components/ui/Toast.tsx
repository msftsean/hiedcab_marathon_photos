...
import { Fragment, createContext, useContext, useState, useCallback, type ReactNode } from 'react';
    ...
    >
      ...
      >
        ...
        <button
          type="button"
          onClick={onClose}
          className="flex-shrink-0 rounded-lg p-1 text-gray-400 hover:bg-white hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 min-h-touch min-w-touch flex items-center justify-center"
        >
